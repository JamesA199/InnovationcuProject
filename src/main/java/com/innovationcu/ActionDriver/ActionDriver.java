package com.innovationcu.ActionDriver;
...
public class ActionDriver extends BaseClass {
	...
	public static boolean findElement(WebDriver driver, WebElement ele) {
		...
		try {
			...
			if (flag) {
				...
				Log.info("Unable to locate element at: "+ele);
			}
		}
		return flag;
	}
	...
	public static boolean isEnabled(WebDriver driver, WebElement ele) {
		...
		if (flag) {
			...
			Log.info("The element could be found: "+ele);
		}
		return flag;
	}
	...
	public static boolean type(WebElement ele, String text) {
		...
		try {
			...
			if (flag) {
				...
				Log.info("Unable to typed text: "+text+", into: "+ele);
			}
	...
	public static void implicitWait(WebDriver driver, long i) {
	...
	public static void pageLoadTimeOut(WebDriver driver, long i) {
