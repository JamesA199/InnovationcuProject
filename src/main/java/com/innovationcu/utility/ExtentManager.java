package com.innovationcu.utility;
...
public class ExtentManager {
	...
	public static void setExtent() {
		...
		htmlReporter= new ExtentHtmlReporter(System.getProperty("user.dir")+"/test-output/ExtentReport/Innovation-Report.html");
		System.out.println(System.getProperty("user.dir")+"/test-output/ExtentReport/Innovation-Report.html");
		...
		extent.setSystemInfo("ProjectName", "Innovationcu Automation Project");
		extent.setSystemInfo("Tester", "jAnderson");
