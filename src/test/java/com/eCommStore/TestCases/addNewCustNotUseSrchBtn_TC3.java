...
public class addNewCustNotUseSrchBtn_TC3 extends BaseClass
{
	...
	public void addNewCustomer_Test() throws Throwable
	{
		...
		Log.startTestCase("************Start addNewCustNotUseSrchBtn_TC3************");
			...
			UserFlows.srchCustomerTablebyCol(strcompanyName, "Company Name", 5);
			
			Thread.sleep(5000);
			landingPageObj.click_logoutBtn();			
			getDriver().quit(); 
			
		Log.endTestCase("************End addNewCustNotUseSrchBtn_TC3************");  
